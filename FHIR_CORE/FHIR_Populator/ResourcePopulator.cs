    ...
    public static class ResourcePopulator
    {
        ...
        public static bool ValidateProfile(Base ProfileInstance, ref string strError_OUT)
        {
            ...
            try
            {
                ...
                string folderPath = Path.Combine(AppContext.BaseDirectory, "FHIRProfile");

                string profiledirectory = folderPath;
        ...
        public static Patient populatePatientResource()
        {
            ...
            text.Status = Narrative.NarrativeStatus.Generated;
            text.Div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">ABC, 41 year, Male</div>";
            patient.Text = text;
        ...
        public static Condition populateConditionResource()
        {
            ...
            Narrative text = new Narrative();
            text.Status = Narrative.NarrativeStatus.Generated;
            text.Div = "<div xmlns=\"http://www.w3.org/1999/xhtml\" xml:lang=\"en-IN\" lang=\"en-IN\">Foot has swollen</div>";
            condition.Text = text;
            ...
            condition.Subject = new ResourceReference("Patient/Patient-01");
        ...
        public static Condition populateSecondConditionResource()
        {
            ...
            condition.Id = "Condition-02";

            // Plain text representation of the concept
            Narrative text = new Narrative();
            text.Status = Narrative.NarrativeStatus.Generated;
            text.Div = "<div xmlns=\"http://www.w3.org/1999/xhtml\" xml:lang=\"en-IN\" lang=\"en-IN\">Past Medical Problem of Diabetes mellitus type1</div>";
            condition.Text = text;
        ...
        public static Condition populateThirdConditionResource()
        {
            ...
            condition.Id = "Condition-03";

            // Plain text representation of the concept
            Narrative text = new Narrative();
            text.Status = Narrative.NarrativeStatus.Generated;
            text.Div = "<div xmlns=\"http://www.w3.org/1999/xhtml\" xml:lang=\"en-IN\" lang=\"en-IN\">Past Medical Problem of Diabetes mellitus type2</div>";
            condition.Text = text;
            condition.ClinicalStatus = new CodeableConcept("http://terminology.hl7.org/CodeSystem/condition-clinical", "recurrence", "Recurrence", "Recurrence");
            condition.Subject = new ResourceReference("Patient/Patient-01");
        ...
        public static Condition populateFourthConditionResource()
        {
            ...
            condition.Id = "Condition-01";

            // Plain text representation of the concept
            Narrative text = new Narrative();
            text.Status = Narrative.NarrativeStatus.Generated;
            text.Div = "<div xmlns=\"http://www.w3.org/1999/xhtml\" xml:lang=\"en-IN\" lang=\"en-IN\">History of aortoiliac atherosclerosis</div>";
            condition.Text = text;
            condition.ClinicalStatus = new CodeableConcept("http://terminology.hl7.org/CodeSystem/condition-clinical", "recurrence", "Recurrence", "Recurrence");
            condition.Subject = new ResourceReference("Patient/Patient-01");
        ...
        public static Condition populateFifthConditionResource()
        {
            ...
            Narrative text = new Narrative();
            text.Status = Narrative.NarrativeStatus.Generated;
            text.Div = "<div xmlns=\"http://www.w3.org/1999/xhtml\" xml:lang=\"en-IN\" lang=\"en-IN\">Myocardial infarction</div>";
            condition.Text = text;
            condition.ClinicalStatus = new CodeableConcept("http://terminology.hl7.org/CodeSystem/condition-clinical", "active", "Active", "Active");
            condition.Subject = new ResourceReference("Patient/Patient-01");
        ...
        public static Composition populatePrescriptionCompositionResource()
        {
            ...
            Narrative text = new Narrative();
            text.Status = Narrative.NarrativeStatus.Generated;
            text.Div ="<div xmlns=\"http://www.w3.org/1999/xhtml\">Prescription report</div>";
            ...
            refrence.Reference = "Patient/Patient-01";
            ...
            composition.Author.Add(new ResourceReference("Practitioner/Practitioner-01"));
        ...
        public static Practitioner populatePractitionerResource()
        {
            ...
            practitioner.Id = "Practitioner-01";

            Narrative text = new Narrative();
            text.Status = Narrative.NarrativeStatus.Generated;
            text.Div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">Dr. DEF, MD (Medicine)</div>";
            practitioner.Text = text;
        ...
        public static Practitioner populateSecondPractitionerResource()
        {
            ...
            practitioner.Id = "Practitioner-02";

            Narrative text = new Narrative();
            text.Status = Narrative.NarrativeStatus.Generated;
            text.Div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">Dr. PQR, MD (Medicine)</div>";
            practitioner.Text = text;
        ...
        public static MedicationRequest populateMedicationRequestResource()
        {
            ...
            medicationRequest.Id = "MedicationRequest-01";
            ...
            medicationRequest.Subject = new ResourceReference("Patient/Patient-01", "ABC");

            medicationRequest.Requester = new ResourceReference("Practitioner/Practitioner-01", "Dr DEF");       
         
          
            medicationRequest.ReasonReference.Add(new ResourceReference("Condition/Condition-01"));
        ...
        public static Composition populateDischargeSummaryCompositionResource()
        {
            ...
            Narrative text = new Narrative();
            text.Status = Narrative.NarrativeStatus.Generated;
            text.Div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"><h4>Narrative with Details</h4><p>This is a Discharge Summary record for Patient ABC. Generated Summary: id: 1; Medical Record Number = 1234 (System : {https://healthid.ndhm.gov.in}); active; ABC ; ph: +919818512600(HOME); gender: male; birthDate: 1981-01-12</p></div>";
            composition.Text = text;
            ...
            composition.Subject = new ResourceReference("Patient/Patient-01");

            // Set Context of the Composition
            composition.Encounter = new ResourceReference("Encounter/Encounter-02");
            ...
            section1.Entry.Add(new ResourceReference("Condition/Condition-02", "Chief complaint section"));
            ...
            section2.Entry.Add(new ResourceReference("Procedure/Procedure-01"));
            section2.Entry.Add(new ResourceReference("Condition/Condition-01"));

            Composition.SectionComponent section3 = new Composition.SectionComponent();
            section3.Title = "Investigations";
            section3.Code = (new CodeableConcept("http://snomed.info/sct", "721981007", "Diagnostic studies report", "null"));
            section3.Entry.Add(new ResourceReference("DiagnosticReport/DiagnosticReport-01", "Diagnostic studies report"));

            Composition.SectionComponent section4 = new Composition.SectionComponent();
            section4.Title="Procedures";
            section4.Code= new CodeableConcept("http://snomed.info/sct", "1003640003", "History of past procedure section", "null");
            section4.Entry.Add(new ResourceReference("Procedure/Procedure-02"));

            Composition.SectionComponent section5 = new Composition.SectionComponent();
            section5.Title="Care Plan";
            section5.Code= new CodeableConcept("http://snomed.info/sct", "734163000", "Care plan", "null");
            section5.Entry.Add(new ResourceReference("CarePlan/CarePlan-01"));

            Composition.SectionComponent section6 = new Composition.SectionComponent();
            section6.Title="Medications";
            section6.Code= new CodeableConcept("http://snomed.info/sct", "1003606003", "Medication history section", "null");
            section6.Entry.Add(new ResourceReference("MedicationRequest/MedicationRequest-01"));

            Composition.SectionComponent section7 = new Composition.SectionComponent();
            section7.Title="Document Reference";
            section7.Code= new CodeableConcept("http://snomed.info/sct", "373942005", "Discharge summary", "null");
            section7.Entry.Add(new ResourceReference("DocumentReference/DocumentReference-01"));
        ...
        public static Organization populateOrganizationResource()
        {
            ...
            var text = new Narrative();
            text.Status = Narrative.NarrativeStatus.Generated;
            text.Div = "<div xmlns=\"http://www.w3.org/1999/xhtml\" xml:lang=\"en-IN\" lang=\"en-IN\">UVW Hospital. ph: +91 273 2139 3632, email:<a href=\"mailto:contact@facility.uvw.org\">contact@facility.uvw.org</a></div>";
        ...
        public static Encounter populateEncounterResource()
        {
            ...
            encounter.Subject = new ResourceReference("Patient/Patient-01");
            ...
            diagnosiscomponent1.Condition = new ResourceReference("Condition/Condition-01");
            ...
            diagnosiscomponent2.Condition = new ResourceReference("Condition/Condition-03");
        ...
        public static Appointment populateAppointmentResource()
        {
            ...
            Narrative text = new Narrative();
            text.Status = Narrative.NarrativeStatus.Generated;
            text.Div = "<div xmlns=\"http://www.w3.org/1999/xhtml\" xml:lang=\"en-IN\" lang=\"en-IN\">Brian MRI results discussion</div>";
            ...
            appointmentparticipantComponent.Actor = new ResourceReference("Patient/Patient-01");
            ...
            appointmentparticipantComponent1.Actor = new ResourceReference("Practitioner/Practitioner-01");
            ...
            appointment.ReasonReference.Add(new ResourceReference("Condition/Condition-01"));
            appointment.BasedOn.Add(new ResourceReference("ServiceRequest/ServiceRequest-01"));
        ...
        public static DiagnosticReport populateDiagonosticReportLabResource()
        {
            ...
            diagnosticReportLab.Id = "DiagnosticReport-01";
            ...
            diagnosticReportLab.BasedOn.Add(new ResourceReference("ServiceRequest/ServiceRequest-01"));
            ...
            diagnosticReportLab.Subject = new ResourceReference("Patient/Patient-01");
            diagnosticReportLab.Issued = new DateTime(2020, 07, 10, 11, 45, 33);
            diagnosticReportLab.Performer.Add(new ResourceReference("Organization/Organization-01"));                       
            diagnosticReportLab.ResultsInterpreter.Add(new ResourceReference("Practitioner/Practitioner-01","Dr.DEF"));
            diagnosticReportLab.Specimen.Add(new ResourceReference("Specimen/Specimen-01"));
          
            diagnosticReportLab.Result.Add(new ResourceReference("Observation/Observation-cholesterol"));
            diagnosticReportLab.Result.Add(new ResourceReference("Observation/Observation-triglyceride"));
            diagnosticReportLab.Result.Add(new ResourceReference("Observation/Observation-cholesterol-in-hdl"));
        ...
        public static Observation populateCholesterolObservationResource()
        {
            ...
            observation.Subject = new ResourceReference("Patient/Patient-01");
            observation.Performer.Add(new ResourceReference("Organization/Organization-01"));
        ...
        public static Observation populateCholesterolInHDLObservationResource()
        {
            Observation observation = new Observation()
            {
                Id = "Observation-cholesterol-in-hdl",
                // Set metadata about the resource - Version Id, Lastupdated Date, Profile
                Meta = new Meta()
                {
                    VersionId = "3",
        ...
        public static Procedure populateProcedureResource()
        {
            ...
            procedure.Subject=new ResourceReference("Patient/Patient-01");
        ...
        public static CarePlan populateCarePlanResource()
        {
            ...
            carePlan.Subject= new ResourceReference("Patient/Patient-01","ABC");
        ...
        public static CarePlan populateSecondCarePlanResource()
        {
            ...
            activitycomponent.OutcomeReference.Add(new ResourceReference("Appointment/Appointment-01"));
        ...
        public static Composition populateOPConsultNoteCompositionResource()
        {
            ...
            // Set Context of the Composition
            composition.Encounter = new ResourceReference("Encounter/Encounter-01");
             
            // Set Timestamp
            composition.DateElement = new FhirDateTime("2017-05-27T11:46:09+05:30");
            
            // Set author - Who and/or what authored the composition/Presciption record
            composition.Author.Add(new ResourceReference("Practitioner/Practitioner-01", "Dr DEF"));

            // Set a Human Readable name/title
            composition.Title = "Consultation Report";

            // Set Custodian - Organization which maintains the composition            
            composition.Custodian = new ResourceReference("Organization/Organization-01", "UVW Hospital");
            ...
            section1.Title="Chief complaints";
            section1.Code= new CodeableConcept("http://snomed.info/sct", "422843007", "Chief complaint section","Chief complaint section");
            section1.Entry.Add(new ResourceReference("Condition/Condition-01"));

            Composition.SectionComponent section2 = new Composition.SectionComponent();
            section2.Title="Allergies";
            section2.Code = new CodeableConcept("http://snomed.info/sct", "722446000", "Allergy record", "null");
            section2.Entry.Add(new ResourceReference("AllergyIntolerance/AllergyIntolerance-01"));

            Composition.SectionComponent section3 = new Composition.SectionComponent();
            section3.Title = "Medical History";
            section3.Code = new CodeableConcept("http://snomed.info/sct", "371529009", "History and physical report", "null");
            section3.Entry.Add(new ResourceReference("Condition/Condition-02"));

            Composition.SectionComponent section4 = new Composition.SectionComponent();
            section4.Title = "Investigation Advice";
            section4.Code = new CodeableConcept("http://snomed.info/sct", "721963009", "Order document", "null");
            section4.Entry.Add(new ResourceReference("ServiceRequest/ServiceRequest-01"));

            Composition.SectionComponent section5 = new Composition.SectionComponent();
            section5.Title = "Medications";
            section5.Code = new CodeableConcept("http://snomed.info/sct", "721912009", "Medication summary document", "null");
            section5.Entry.Add(new ResourceReference("MedicationStatement/MedicationStatement-01"));
            section5.Entry.Add(new ResourceReference("MedicationRequest/MedicationRequest-01"));

            Composition.SectionComponent section6 = new Composition.SectionComponent();
            section6.Title = "Procedure";
            section6.Code = new CodeableConcept("http://snomed.info/sct", "371525003", "Clinical procedure report", "null");
            section6.Entry.Add(new ResourceReference("Procedure/Procedure-01"));

            Composition.SectionComponent section7 = new Composition.SectionComponent();
            section7.Title = "Follow Up";
            section7.Code = new CodeableConcept("http://snomed.info/sct", "736271009", "Outpatient care plan", "null");
            section7.Entry.Add(new ResourceReference("Appointment/Appointment-01"));

            Composition.SectionComponent section8 = new Composition.SectionComponent();
            section8.Title = "Document Reference";
            section8.Code = new CodeableConcept("http://snomed.info/sct", "371530004", "Clinical consultation report", "null");
            section8.Entry.Add(new ResourceReference("DocumentReference/DocumentReference-01"));
            ...
            composition.Section.Add(section6);
            composition.Section.Add(section7);
            composition.Section.Add(section8);
        ...
        public static AllergyIntolerance populateAllergyIntoleranceResource()
        {
            ...
            // Set logical id of this artifact
            allergyIntolerance.Id = "AllergyIntolerance-01";
            ...
            allergyIntolerance.Patient = new ResourceReference("Patient/Patient-01");
            ...
            allergyIntolerance.Recorder = new ResourceReference("Practitioner/Practitioner-01");
        ...
        public static ServiceRequest populateServiceRequestResource()
        {
            ...
            serviceRequest.Id ="ServiceRequest-01";
            // Plain text representation of the concept
            Narrative text = new Narrative();
            text.Status = Narrative.NarrativeStatus.Generated;
            text.Div = "<div xmlns=\"http://www.w3.org/1999/xhtml\" xml:lang=\"en-IN\" lang=\"en-IN\">Service Request for fasting lipid profile</div>";
            serviceRequest.Text = text;

            serviceRequest.Status = RequestStatus.Active;
            serviceRequest.Intent = RequestIntent.OriginalOrder;
           
            serviceRequest.Subject= new ResourceReference("Patient/Patient-01");
            serviceRequest.Occurrence = new FhirDateTime("2020-07-09T15:32:26.181+05:30"); 
            serviceRequest.Requester = new ResourceReference("Practitioner/Practitioner-02", "Dr PQR");
        ...
        public static MedicationStatement populateMedicationStatementResource()
        {
            ...
            medicationStatement.Id ="MedicationStatement-01";
            // Plain text representation of the concept
            Narrative text = new Narrative();
            text.Status = Narrative.NarrativeStatus.Generated;
            text.Div = "<div xmlns=\"http://www.w3.org/1999/xhtml\" xml:lang=\"en-IN\" lang=\"en-IN\">Atenolol 500 microgram/mL solution for injection</div>";
            ...
            medicationStatement.Subject=new ResourceReference("Patient/Patient-01");
        ...
        public static Composition populateHealthDocumentRecordCompositionResource()
        {
            ...
            Narrative text = new Narrative();
            text.Status = Narrative.NarrativeStatus.Generated;
            text.Div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"><h4>Narrative with Details</h4><p>This is a Health Document of Patient ABC. Generated Summary: id: 1; Medical Record Number = 1234 (System : {https://healthid.ndhm.gov.in}); active; ABC ; ph: +919818512600(HOME); gender: male; birthDate: 1981-01-12</p></div>";
            composition.Text = text;
            ...
            composition.Subject = (new ResourceReference("Patient/Patient-01", "ABC"));
            ...
            ResourceReference reference3 = new ResourceReference();
            reference3.Reference="DocumentReference/DocumentReference-01";

            Composition.SectionComponent section = new Composition.SectionComponent();
            section.Title ="HeathDocument record";
            section.Entry.Add(new ResourceReference("DocumentReference/DocumentReference-01"));
            composition.Section.Add(section);
        ...
        public static Composition populateDiagnosticReportRecordDCMCompositionResource()
        {
            ...
            // Entry is a reference to data that supports this section
            ResourceReference reference1 = new ResourceReference();
            reference1.Reference ="DiagnosticReport/DiagnosticReport-01";
            reference1.Type="DiagnosticReport";

            ResourceReference reference2 = new ResourceReference();
            reference2.Reference="DocumentReference/DocumentReference-01";
        ...
        public static DiagnosticReport populateDiagnosticReportImagingDCMResource()
        {
            ...
            diagnosticReportImaging.Id= "DiagnosticReport-01";

            // Plain text representation of the concept
            Narrative text = new Narrative();
            text.Status = Narrative.NarrativeStatus.Generated;
            text.Div = "<div xmlns=\"http://www.w3.org/1999/xhtml\" xml:lang=\"en-IN\" lang=\"en-IN\"> <h3>Diagnostic Report for ABC issued 9-July 2020 14:26</h3> <pre> code: CT of head-neck Imaging Study: HEAD and NECK CT DICOM imaging study Conclusion: CT brains: large tumor sphenoid/clivus. </pre> <p>XYZ Lab Pvt.Ltd., Inc signed: Dr. DEF Radiologist</p> </div>";
            diagnosticReportImaging.Text = text;
            ...
            diagnosticReportImaging.BasedOn.Add(new ResourceReference("ServiceRequest/ServiceRequest-01"));
            ...
            diagnosticReportImaging.Subject = new ResourceReference("Patient/Patient-01");
            diagnosticReportImaging.Issued = new DateTime(2020,07,10,11,45,33);
            diagnosticReportImaging.Performer.Add(new ResourceReference("Organization/Organization-01", "XYZ Lab Pvt.Ltd."));
            diagnosticReportImaging.ResultsInterpreter.Add(new ResourceReference("Practitioner/Practitioner-01", "Dr. DEF"));
            diagnosticReportImaging.ImagingStudy.Add(new ResourceReference("ImagingStudy/ImagingStudy-01", "HEAD and NECK CT DICOM imaging study"));


            var link = new DiagnosticReport.MediaComponent();
            link.Link = new ResourceReference("Media/Media-01");                     
        ...
        public static DiagnosticReport populateDiagnosticReportMediaResource()
        {
            ...
            diagnosticReportmedia.Id = "DiagnosticReport-01";

            // Plain text representation of the concept
            Narrative text = new Narrative();
            text.Status = Narrative.NarrativeStatus.Generated;
            text.Div = "<div xmlns=\"http://www.w3.org/1999/xhtml\" xml:lang=\"en-IN\" lang=\"en-IN\"> <h3>Diagnostic Report for ABC issued 9-July 2020 14:26</h3> <pre> code: CT of head-neck Imaging Study: HEAD and NECK CT DICOM imaging study Conclusion: CT brains: large tumor sphenoid/clivus. </pre> <p>XYZ Lab Pvt.Ltd., Inc signed: Dr. DEF Radiologist</p> </div>";
            diagnosticReportmedia.Text = text;
            ...
            diagnosticReportmedia.BasedOn.Add(new ResourceReference("ServiceRequest/ServiceRequest-01"));
            ...
            diagnosticReportmedia.Subject = new ResourceReference("Patient/Patient-01");
            diagnosticReportmedia.Issued = new DateTime(2020, 07, 10, 11, 45, 33);
            diagnosticReportmedia.Performer.Add(new ResourceReference("Organization/Organization-01", "XYZ Lab Pvt.Ltd."));
            diagnosticReportmedia.ResultsInterpreter.Add(new ResourceReference("Practitioner/Practitioner-01", "Dr. DEF"));
        ...
        public static ImagingStudy populateImagingStudyResource()
        {
            ...
            imagingStudy.Id = "ImagingStudy-01";
            // Plain text representation of the concept
            Narrative text = new Narrative();
            text.Status = Narrative.NarrativeStatus.Generated;
            text.Div = "<div xmlns=\"http://www.w3.org/1999/xhtml\" xml:lang=\"en-IN\" lang=\"en-IN\">HEAD and NECK CT DICOM imaging study</div>";
            imagingStudy.Text = text;
            ...
            imagingStudy.Subject= new ResourceReference("Patient/Patient-01");
            imagingStudy.Interpreter.Add(new ResourceReference("Practitioner/Practitioner-01"));
        ...
        public static Media populateMediaResource()
        {
            ...
            media.Subject=new ResourceReference("Patient/Patient-01");
       ...
       public static Composition populateDiagnosticReportRecordLabCompositionResource()
        ...
        public static DiagnosticReport populateDiagnosticReportImagingMediaResource()
        {
            ...
            diagnosticReportImaging.ResultsInterpreter.Add(new ResourceReference("Organization/Organization-01","Dr. DEF"));
            var link = new DiagnosticReport.MediaComponent();
            link.Link = new ResourceReference("Media/Media-01");
            diagnosticReportImaging.Media.Add(link);
            diagnosticReportImaging.Conclusion="CT brains: large tumor sphenoid/clivus.";
        ...
        public static Composition populateImmunizationRecordCompositionResource()
        {
            ...
            Narrative text = new Narrative();
            text.Status= Narrative.NarrativeStatus.Generated;
            text.Div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"><h4>Narrative with Details</h4></div>"; 
            ...
            ResourceReference reference1 = new ResourceReference();
            reference1.Reference="Immunization/Immunization-01";
            reference1.Type="Immunization";

            ResourceReference reference2 = new ResourceReference();
            reference2.Reference ="ImmunizationRecommendation/ImmunizationRecommendation-01";
        ...
        public static Immunization populateImmunizationResource()
        {
            ...
            immunization.Patient=new ResourceReference("Patient/Patient-01");
        ...
        public static ImmunizationRecommendation populateImmunizationRecommendation()
        {
            ...
            immunizationRecommendation.Id="1";
            immunizationRecommendation.Patient=new ResourceReference("Patient/Patient-01");
            immunizationRecommendation.Authority =new ResourceReference("Organization/Organization-01");
            immunizationRecommendation.DateElement = new FhirDateTime("2021-01-10T11:04:15.817-05:00");
            var text = new Narrative();
            text.Status = Narrative.NarrativeStatus.Generated;
            text.Div="<div xmlns=\"http://www.w3.org/1999/xhtml\">This is Immunization Recommendation for COVID-19 mRNA vaccine to be taken on 2021-05-10.</div>";
            immunizationRecommendation.Text = text;
            ...
            immnunizationRecommendationRecommendationComponent.SupportingImmunization.Add(new ResourceReference("Immunization/Immunization-01"));
        ...
        public static Composition populateWellnessRecordCompositionResource()
        {
            ...
            section1.Entry.Add(new ResourceReference("Observation/respiratory-rate"));
            section1.Entry.Add(new ResourceReference("Observation/heart-rate"));
            section1.Entry.Add(new ResourceReference("Observation/oxygen-saturation"));
            section1.Entry.Add(new ResourceReference("Observation/body-temperature"));
            section1.Entry.Add(new ResourceReference("Observation/blood-pressure"));


            Composition.SectionComponent section2 = new Composition.SectionComponent();
            section2.Title="Body Measurement";
            section2.Entry.Add(new ResourceReference("Observation/body-height"));
            section2.Entry.Add(new ResourceReference("Observation/body-weight"));
            section2.Entry.Add(new ResourceReference("Observation/bmi"));


            Composition.SectionComponent section3 = new Composition.SectionComponent();
            section3.Title= "Physical Activity";
            section3.Entry.Add(new ResourceReference("Observation/StepCount"));
            section3.Entry.Add(new ResourceReference("Observation/CaloriesBurned"));
            section3.Entry.Add(new ResourceReference("Observation/SleepDuration"));

            Composition.SectionComponent section4 = new Composition.SectionComponent();
            section4.Title="General Assessment";
            section4.Entry.Add(new ResourceReference("Observation/BodyFatMass"));
            section4.Entry.Add(new ResourceReference("Observation/BloodGlucose"));
            section4.Entry.Add(new ResourceReference("Observation/FluidIntake"));
            section4.Entry.Add(new ResourceReference("Observation/CalorieIntake"));


            Composition.SectionComponent section5 = new Composition.SectionComponent();
            section5.Title="Women Health";
            section5.Entry.Add(new ResourceReference("Observation/AgeOfMenarche"));
            section5.Entry.Add(new ResourceReference("Observation/LastMenstrualPeriod"));

            Composition.SectionComponent section6 = new Composition.SectionComponent();
            section6.Title="Lifestyle";
            section6.Entry.Add(new ResourceReference("Observation/DietType"));
            section6.Entry.Add(new ResourceReference("Observation/TobaccoSmokingStatus"));
        ...
        public static Observation populateRespitaryRateResource()
        {
            ...
            observation.Id="respiratory-rate";
        ...
        public static Observation populateHeartRateResource()
        {
            ...
            observation.Subject= new ResourceReference("Patient/1");
            observation.Effective = new FhirDateTime("2020-09-29");
            var quantity = new Quantity(26, "breaths/minute", "http://unitsofmeasure.org");
            quantity.Code = "/min";
            observation.Value = quantity;           
            return observation;
        }
        ...
        public static Observation populateOxygenSaturationResource()
        {
            ...
            observation.Id ="oxygen-saturation";
            ...
            observation.Status = ObservationStatus.Final;
            observation.Category.Add(new CodeableConcept("http://terminology.hl7.org/CodeSystem/observation-category", "vital-signs", "Vital Signs", "Vital Signs"));             
            observation.Code=new CodeableConcept("http://loinc.org", "2708-6", "Oxygen saturation in Arterial blood","Vital Signs");
            observation.Subject =new ResourceReference("Patient/Patient-01");
            ...
            observation.Device=new ResourceReference("DeviceMetric/example");
            Observation.ReferenceRangeComponent obserrefrange = new Observation.ReferenceRangeComponent();
        ...
        public static Observation populateBodyTemperatureResource()
        {
            ...
            observation.Id="body-temperature";
        ...
        public static Observation populateAgeOfMenarcheResource()
        {
            ...
            observation.Id="AgeOfMenarche";
            var text = new Narrative();
            text.Status=Narrative.NarrativeStatus.Generated;
            text.Div="<div xmlns=\"http://www.w3.org/1999/xhtml\"><p><b>Narrative with Details</b></p><p><b>id</b>: AgeOfMenarche</p><p><b>status</b>: final</p><p><b>code</b>: Age at menarche <span>(Details : LOINC code '42798-9' = 'Age at menarche', given as 'Age at menarche')</span></p><p><b>subject</b>: ABC</p><p><b>value</b>: 14 age</p></div>";
            observation.Text = text;
            observation.Status = ObservationStatus.Final; 
        ...
        public static Observation populateLastMenstrualPeriodResource()
        {
            ...
            observation.Id="LastMenstrualPeriod";
            var text = new Narrative();
            text.Status = Narrative.NarrativeStatus.Generated;
        ...
        public static Observation populateDietTypeResource()
        {
            ...
            observation.Subject= new ResourceReference("Patient/Patient-01");
            observation.Value =new CodeableConcept("http://snomed.info/sct", "24930006", "Vegan", "Vegan");
        ...
        public static Observation populateTobaccoSmokingStatusResource()
        {
            ...
            observation.Id="TobaccoSmokingStatus";
            var text = new Narrative();
            text.Status = Narrative.NarrativeStatus.Generated;
        ...
        public static Coverage populateCoverageResource()
        {
            ...
            coverage.Subscriber = new ResourceReference("Patient/Patient-01");
            coverage.Beneficiary = new ResourceReference("Patient/Patient-01");
            ...
            coverage.Payor.Add(new ResourceReference("Organization/Organization-01"));
        ...
        public static Signature populateSignature()
        {
            ...
            signature.Who = new ResourceReference("Practitioner/Practitioner-01");
        ...
        internal static bool seralize_WriteFile(string v, object populatePatientResource)
        {
